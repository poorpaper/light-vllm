...
CMD ["--host", "0.0.0.0", "--port", "8000", "--architecture", "qwen2.5", "--loader", "safetensors", "--weights", "/models/model", "--tokenizer", "/models/model", "--served-model-name", "model", "--device", "cuda:0", "--dtype", "bfloat16", "--runtime", "engine", "--engine-process", "--kv-reservation", "blocks", "--paged-attention-backend", "triton"]
